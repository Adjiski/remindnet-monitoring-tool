...
def initialize_earth_engine() -> None:
    ...
    project_id = _config_value("GEE_PROJECT_ID") or _config_value("EE_PROJECT_ID")
    service_account = _config_value("GEE_SERVICE_ACCOUNT_EMAIL")
    key_path = _config_value("GEE_SERVICE_ACCOUNT_KEY_PATH")
    key_json = _config_value("GEE_SERVICE_ACCOUNT_KEY_JSON")
